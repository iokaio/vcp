...
[prospective follow-up design](cs1-follow-up-design.md) records the separate
qualification path; its execution evidence belongs to its exact frozen artifacts
and cannot relabel historical results as passing. Any changed
