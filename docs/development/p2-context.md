...
records input hashes, commands, toolchain, filesystem and the 27 current tests,
including native mutation and [compaction](p2-context-continuity.md) regressions.
