...
exact installed executable passed: body/resource activation, relocated discovery
and integrity, and terminal controls. An initial terminal selector matched no
tests; only the corrected, actually executed test is counted.

Archive SHA-256:
`06cf4dafb370ca624ba15b2f177f464791e9b1557506629d789811c232f19845`.
Executable SHA-256:
...
parent directories in the preparation: the permitted patch tool requires existing
