...
- [Architecture decision records](adr/README.md): 27 records covering the original decision subjects, subsequent engineering decisions and outstanding qualification.
...
Concrete product toolchain/setup, source mappings, public protocol references, operational procedures and further evaluation summaries will be added with their owning implementation work. Existing product design guides and ADRs are preparation, not runtime evidence. See the layout for their reserved locations.
