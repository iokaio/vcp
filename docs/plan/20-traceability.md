...
| P1-01 Domain state | P0-06 | [Implementation and tests](02-engine-state-and-capture.md#p1-01--domain-state) | [Foundation implementation](../development/p1-foundation.md): generated transitions, current verification and stable rebinding; retained controller integration remains | in_progress |
| P1-02 Internal commands/events | P1-01, P0-03 | [Implementation and tests](02-engine-state-and-capture.md#p1-02--internal-commands-and-events) | [Foundation implementation](../development/p1-foundation.md): durable receipts, authenticated retries, JSONL parity and bounded subscriptions; retained consumers remain | in_progress |
| P1-03 Full capture/artifacts | P1-01 | [Implementation and tests](02-engine-state-and-capture.md#p1-03--full-capture-and-artifact-staging) | [Foundation implementation](../development/p1-foundation.md): full binary capture, prefix recovery, omission boundaries and failure fencing; retained transport/output integration remains | in_progress |
| P1-04 Canonical backends | P1-01/03, P0-04/06 | [Implementation and tests](03-storage-and-budget.md#p1-04--storage-increments) | [Foundation](../development/p1-foundation.md) and [accounting/history](../development/p1-accounting-history.md): shared backend constraints, combined ledger transaction crashes and conversion; retained acceptance remains | in_progress |
| P1-05 Budget ledger | P1-04 | [Implementation and tests](03-storage-and-budget.md#p1-05--ledger-increments) | [Accounting/history](../development/p1-accounting-history.md): root races, child/daily caps, immutable adjustments, unknown liabilities and reopen; retained request paths remain | in_progress |
| P1-06 Projections and history | P1-02/04 | [Implementation and tests](02-engine-state-and-capture.md#p1-06--projections-and-history) | [Accounting/history](../development/p1-accounting-history.md): fresh-process rebuild, atomic version activation, current-authority filters and explicit gaps; retained trace acceptance remains | in_progress |
