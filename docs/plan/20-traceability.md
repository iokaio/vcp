...
| P1-04 Canonical backends | P1-01/03, P0-04/06 | [Implementation and tests](03-storage-and-budget.md#p1-04--storage-increments) | [Foundation implementation](../development/p1-foundation.md): shared backend/crash/activation contracts; accounting constraints and combined ledger transaction fixture remain | in_progress |
