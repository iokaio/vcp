...
| P0-03 Internal lifecycle seam | P0-07 | [Implementation and tests](01-upstream-feasibility.md#p0-03--codex-lifecycle-seam) | [Continuation admission regressions](../evaluations/p0-03-continuation-admission.md), [scoped host qualification](../evaluations/p0-03-scoped-lifecycle.md); startup/effect fencing, durable recovery, process quiescence and CLI pause remain required | in_progress |
