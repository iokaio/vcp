...
| P9-02 Server/attach | P9-01 | [Implementation and tests](17-deferred-api-and-sdk.md#p9-02--local-server-and-attachment) | [Live host and controller construction](../development/local-attachment.md): owned steering/draining, connection-loss pause, retained command identity; authenticated processes and live cursor recovery still require qualification | In_progress |
