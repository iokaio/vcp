...
| P7-04 Task graph/worktrees | P6-03, P2-07 | [Implementation and tests](14-visible-delegation.md#p7-04--graph-and-workspace-ownership) | E12/E15/U06; [graph/workspace implementation](../development/p7-child-workspaces.md), connected native graph/workspace fixtures passing, final qualification open; no silent shared writes or orphan charge history | In_progress |
| P7-05 Integration/review | P7-04, P2-06 | [Implementation and tests](14-visible-delegation.md#p7-05--integration-and-review) | U02/U03/E15; three-way result planning and broker integration implemented; interruption and usefulness qualification open; successful child cannot bypass failed integrated verification | In_progress |
| P7-06 Visible progress and recovery | P7-04/05, P3-02/04 | [Implementation and tests](14-visible-delegation.md#p7-06--commentary-controls-and-recovery) | U06; attributed child views, explicit recovery and native live-terminal pause fixtures implemented; final U06 qualification open; child failures/blocks/costs always visible; quiet mode still announces delegation | In_progress |
| P8-01 Native Windows matrix | P3-06, P6-04, P7-02/03/06 | [Implementation and tests](15-integration-and-release.md#p8-01--native-windows-support-matrix) | E07/E08/E18/U09; [native matrix and CPU measurements](../evaluations/p8-native-qualification-2026-09-22.md) recorded; clean OS and full packaged coverage open | In_progress |
| P8-02 Recovery/portability campaign | P7-06, P5-07/10, P3-05/06 | [Implementation and tests](15-integration-and-release.md#p8-02--recovery-and-portability-campaign) | E10/E14/M02/M07/M08/U04–U06; native recovery and real cleanup receipt-interruption cases pass on both stores; broader fault schedule open | In_progress |
| P8-03 Full-history/export review | P3-05/06, P5-07/10 | [Implementation and tests](15-integration-and-release.md#p8-03--full-history-and-encryption-review) | U04/U05/I-19; history, compaction, tamper and local key-handoff rows pass; independent second-machine encrypted recovery not run | In_progress |
| P8-04 Windows distribution | P8-01, P5-10 | [Implementation and tests](15-integration-and-release.md#p8-04--windows-distribution) | Unsigned candidate, standalone installer and model provisioner implemented; exact-artifact same-host smoke passes; fresh-machine transfer remains open | In_progress |
...
[workflow evidence](../evaluations/p7-02-workflow.md) and [live completion](../evaluations/p7-02-completion.md). Other additions below remain
planned. Primary task rows retain all unpassed gates.
...
| [CR-03 helper defaults](22-cursor-improvements.md#cr-03--small-helper-role-defaults) | P7-04/06; existing graph and routing | Bounded useful read-only helpers, inherited authority/root budget, concise attributed progress and single-agent path | implemented; full usefulness qualification open |
| [CR-08 / CC-15 worktree readiness and cleanup](22-cursor-improvements.md#cr-08--worktree-readiness-and-safe-cleanup) | P7-04/05/06; existing snapshots/markers, then P8-02 | Actionable setup state, exact registered-root cleanup, preserved live references/history and interrupted/locked-root recovery | implemented; native cleanup cases pass, broader fault schedule open |
| [CR-12a / CC-14a review findings](22-cursor-improvements.md#cr-12a--useful-local-review-findings) | P7-05; P7-02 shared review guidance, then P8-05 | Evidence-backed current-revision findings, honest causality/verification, U02 quality and integrated-parent checks | implemented; [Luna review passes](../evaluations/p7-review-generation-quality-2026-09-22.md); [Qwen 3.8 generation passes, paired review remains open](../evaluations/p7-qwen38-reasoning-budget-2026-09-22.md) |
