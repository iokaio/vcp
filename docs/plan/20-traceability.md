...
| P0-07 Upstream pins | P0-01 | [Implementation and tests](01-upstream-feasibility.md#p0-07--immutable-upstream-selection) | Immutable manifest, R08; [Codex import](../evaluations/p0-07-codex-import.md), [native datastore](../evaluations/p0-07-munarium-datastore.md), [shared Munarium import](../evaluations/p0-07-munarium-import.md), [Gemini boundaries](../evaluations/p0-07-gemini-baseline.md), [local CPU embeddings](../evaluations/p0-07-local-embeddings.md), [static boundaries](../evaluations/p0-07-boundary-inventory.md), [helper traces](../evaluations/p0-07-helper-traces.md) and [hosted Windows](../evaluations/p0-07-hosted-windows.md); remaining selections/effect qualification open | in_progress |
