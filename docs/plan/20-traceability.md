...
| P2-03 Autonomy and grants | P1-01/04, P0-05/06 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-03--effective-autonomy-and-grants) | [Authority core](../evaluations/p2-policy-increment.md) and [native file dispatch](../evaluations/p2-tools-increment.md): scoped grants, denials and durable questions/answers; process authority remains | in_progress |
| P2-04 Execution/tools | P2-03, P1-03/04 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-04--tools-and-windows-worker) | [Prepared native files](../evaluations/p2-tools-increment.md): exact preparation, Windows guards and partial-effect receipts; process and full recovery integration remain | in_progress |
