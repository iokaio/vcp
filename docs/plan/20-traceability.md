...
| P2-08 Context continuity | P2-01/05, P1-05/06 | [Implementation and tests](04-context-and-instructions.md#p2-08--refresh-and-compaction) | [Deterministic compaction](../development/p2-context-continuity.md): complete-pair previews and current-source reuse checks; retained integration and full E04/R07 remain | in_progress |
