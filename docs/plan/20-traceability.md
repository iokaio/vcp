...
| P2-06 Verification/completion | P2-05 | [Implementation and tests](05-openrouter-and-session-loop.md#p2-06--verification-and-honest-completion) | [Native verification increment](../development/p2-verification.md): project check discovery, stale evidence, native completion gate; full framework/loop acceptance remains | in_progress |
