...
| P0-07 Upstream pins | P0-01 | [Implementation and tests](01-upstream-feasibility.md#p0-07--immutable-upstream-selection) | Immutable manifest, R08; [Codex import](../evaluations/p0-07-codex-import.md) and [native datastore](../evaluations/p0-07-munarium-datastore.md) evidence; remaining selections/effect qualification open | in_progress |
