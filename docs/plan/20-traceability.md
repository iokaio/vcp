...
| P2-03 Autonomy and grants | P1-01/04, P0-05/06 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-03--effective-autonomy-and-grants) | [Authority core](../evaluations/p2-policy-increment.md) and [native file dispatch](../evaluations/p2-tools-increment.md): scoped grants and durable questions; [native process authority](../evaluations/p2-process-increment.md) added; coordinated revocation remains | in_progress |
| P2-04 Execution/tools | P2-03, P1-03/04 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-04--tools-and-windows-worker) | [Prepared native files](../evaluations/p2-tools-increment.md): exact preparation, Windows guards and partial-effect receipts; [process profiles](../evaluations/p2-process-increment.md) added; PTY and full recovery integration remain | in_progress |
