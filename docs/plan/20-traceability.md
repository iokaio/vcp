...
P9-01 is complete; P9-02 is in progress. P9-03 and P4-01 retain their dependency order.
...
| P9-02 Server/attach | P9-01 | [Implementation and tests](17-deferred-api-and-sdk.md#p9-02--local-server-and-attachment) | [Live host and authenticated local attachment](../development/local-attachment.md), [native bootstrap decision](../adr/044-controlled-local-process-bootstrap.md): controller ownership, authenticated attachment, owned run-start/explicit resume, atomic metadata forks, snapshot/event recovery and scoped workspace/artifact/usage/context/routing inspection; native qualification is recorded per increment in the construction guide; remaining inspection/governance/editor adapters, pending-input/crash/consumer scenarios and SDK acceptance remain | In_progress |
