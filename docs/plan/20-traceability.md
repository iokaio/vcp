...
Status: early implementation. Ownership inventory from architecture draft 0.4 and the task headings in this directory, expanded with implementation/design traceability on September 17, 2026. All 68 architecture items have exactly one implementation owner. There are 56 first-release items and 12 deferred items (P4, P9 and P10). P0-01 has [completed infrastructure evidence](../evaluations/p0-01-experiment-harness.md), and P0-07 has [completed selection evidence](../evaluations/p0-07-selection-gate.md). P0-02 has [completed bounded feasibility evidence](../evaluations/p0-02-local-resources.md); P0-03 and P0-05 have [completed recovery/execution feasibility evidence](../evaluations/p0-03-recovery-execution.md). All P0 tasks have bounded qualification evidence. P1-01 through P1-06 are complete with [native canonical foundation acceptance](../evaluations/p1-completion.md); P2-01 is in progress with [repository/context foundation evidence](../evaluations/p2-context-increment.md). P2-02 is in progress with [provider gateway evidence](../evaluations/p2-provider-increment.md). P2-03 is in progress with [authority core evidence](../evaluations/p2-policy-increment.md). P2-04 is in progress with [prepared native files](../development/p2-tools.md). P2-05 is in progress with the [canonical coding milestone](../development/p2-canonical-coding-loop.md). P2-06 is in progress with [native verification](../development/p2-verification.md). P2-08 is in progress with [deterministic compaction](../development/p2-context-continuity.md). Other tasks remain planned and dependencies are unchanged.
...
| P2-01 Repository/context | P1-03/04 | [Implementation and tests](04-context-and-instructions.md#p2-01--discovery-and-initial-assembly) | [Native context increment](../evaluations/p2-context-increment.md): scoped observations, captured selection and stale dependency checks; [retained request admission](../evaluations/p2-provider-increment.md) now exercised | in_progress |
| P2-02 OpenRouter gateway | P1-05, P0-09 | [Implementation and tests](05-openrouter-and-session-loop.md#p2-02--provider-path) | [Provider increment](../evaluations/p2-provider-increment.md): bounded codec, retained send fence and observed settlement; retry orchestration and capped live smoke remain | in_progress |
| P2-03 Autonomy and grants | P1-01/04, P0-05/06 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-03--effective-autonomy-and-grants) | [Authority core](../evaluations/p2-policy-increment.md), [native file dispatch](../evaluations/p2-tools-increment.md), [process authority](../evaluations/p2-process-increment.md), [opaque denials](../evaluations/p2-execution-ceilings.md), [coordinated changes](../evaluations/p2-authority-coordination.md) and [host tool ceilings](../evaluations/p2-host-tool-authority.md); full loop acceptance remains | in_progress |
| P2-04 Execution/tools | P2-03, P1-03/04 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-04--tools-and-windows-worker) | [Prepared native files](../evaluations/p2-tools-increment.md), [process profiles](../evaluations/p2-process-increment.md), [owned terminal input/output](../evaluations/p2-pty-increment.md) and [native process-count limits](../evaluations/p2-execution-ceilings.md); interactive control and full recovery integration remain | in_progress |
| P2-05 Session loop | P2-01…04, P0-08/09 | [Implementation and tests](05-openrouter-and-session-loop.md#p2-05--retained-codex-loop-with-vcp-boundaries) | [Canonical coding milestone](../evaluations/p2-canonical-coding-loop.md): prepared wrappers, automatic assembly, current instructions, durable pairs and request bounds; full session-loop acceptance remains | in_progress |
| P2-06 Verification/completion | P2-05 | [Implementation and tests](05-openrouter-and-session-loop.md#p2-06--verification-and-honest-completion) | [Native verification](../development/p2-verification.md), [Cargo/documentation checks](../evaluations/p2-framework-verification.md) and [retained integration](../development/p2-loop-verification.md): observed checks, source applicability and final-cost evidence; full loop/recovery acceptance remains | in_progress |
...
| P2-08 Context continuity | P2-01/05, P1-05/06 | [Implementation and tests](04-context-and-instructions.md#p2-08--refresh-and-compaction) | [Deterministic compaction](../development/p2-context-continuity.md): complete-pair previews, current-source reuse checks and retained owner integration; full E04/R07 remain | in_progress |
