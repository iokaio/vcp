...
| P9-02 Server/attach | P9-01 | [Implementation and tests](17-deferred-api-and-sdk.md#p9-02--local-server-and-attachment) | Canonical controller leases and host-aware dispatch in construction; authenticated processes, owner loss and live cursor recovery still require qualification | In_progress |
