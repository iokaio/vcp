...
| M2 escalation integration | P6-03 after M1 | Canonical advisory lifecycle, exact-cycle rules, separate local statistical shadow provenance, bounded/stale/pause tests | in progress: immutable request/result records and stale disposition implemented |
