...
| P7-03 MCP | P7-01, P2-03/04 | [Implementation and tests](13-skills-and-mcp.md#p7-03--mcp-lifecycle-and-tool-calls) | [Governed stdio qualification](../evaluations/p7-03-stdio.md) covers local protocol, identity, source fences and unknown outcomes; E16/R06/U08 HTTP, credentials and resources remain open | In_progress |
