...
| P0-07 Upstream pins | P0-01 | [Implementation and tests](01-upstream-feasibility.md#p0-07--immutable-upstream-selection) | Immutable manifest, reproducible source selection, R08; [Codex import evidence](../evaluations/p0-07-codex-import.md); remaining selections/effect qualification open | in_progress |
