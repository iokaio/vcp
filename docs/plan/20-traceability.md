...
| P2-04 Execution/tools | P2-03, P1-03/04 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-04--tools-and-windows-worker) | [Prepared native files](../evaluations/p2-tools-increment.md), [process profiles](../evaluations/p2-process-increment.md) and [owned terminal input/output](../evaluations/p2-pty-increment.md); interactive control and full recovery integration remain | in_progress |
