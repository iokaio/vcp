...
| P4-01 Engine connection | P9-02/03 | [Implementation and tests](18-deferred-vscode.md#p4-01--connection-and-workspace-mapping) | [Initial observer connection](../development/editor-connection.md); full mapping/trust/reload acceptance remains open | In_progress |
