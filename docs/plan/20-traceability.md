...
| P0-02 Local memory/runtime spike | P0-07 | [Implementation and tests](01-upstream-feasibility.md#p0-02--local-munarium-and-search-spike) | [Real corpus/index evidence](../evaluations/p0-02-local-corpus.md), [governance qualification](../evaluations/p0-02-local-governance.md); durable canonical integration, observed local network boundary and broader resource/install measurements remain open; U09 | in_progress |
