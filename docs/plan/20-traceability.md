...
| P2-03 Autonomy and grants | P1-01/04, P0-05/06 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-03--effective-autonomy-and-grants) | [Authority core](../evaluations/p2-policy-increment.md), [native file dispatch](../evaluations/p2-tools-increment.md), [process authority](../evaluations/p2-process-increment.md), [opaque denials](../evaluations/p2-execution-ceilings.md) and [coordinated changes](../evaluations/p2-authority-coordination.md); host-rule configuration and full loop acceptance remain | in_progress |
