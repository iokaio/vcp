...
| P2-03 Autonomy and grants | P1-01/04, P0-05/06 | [Implementation and tests](06-windows-tools-and-recovery.md#p2-03--effective-autonomy-and-grants) | [Authority core](../evaluations/p2-policy-increment.md) and [native file dispatch](../evaluations/p2-tools-increment.md): scoped grants and durable questions; [native process authority](../evaluations/p2-process-increment.md) and [opaque denial ceilings](../evaluations/p2-execution-ceilings.md) added; coordinated revocation remains | in_progress |
