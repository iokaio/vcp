...
| P9-02 Server/attach | P9-01 | [Implementation and tests](17-deferred-api-and-sdk.md#p9-02--local-server-and-attachment) | [Live host and controlled stdio](../development/local-attachment.md), [native bootstrap decision](../adr/044-controlled-local-process-bootstrap.md): controller wire methods, owned draining, process identity and writer exclusion; named-pipe reconnect, remaining execution adapters and live cursor recovery still require qualification | In_progress |
