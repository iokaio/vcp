...
P9-01 is the next ready item; P9-02/03 and P4-01 retain their dependency order.
...
| P9-01 Public protocol | P8-05, P1-02 | [Implementation and tests](17-deferred-api-and-sdk.md#p9-01--public-protocol) | [Public wire and initial adapter contract](../development/public-protocol.md), [schema/identity decision](../adr/043-public-protocol-schema-and-identity.md); native codec, compatibility, scoped-query and receipt-replay tests; remaining execution-host methods retain their P9 integration acceptance | In_progress |
