...
| P9-02 Server/attach | P9-01 | [Implementation and tests](17-deferred-api-and-sdk.md#p9-02--local-server-and-attachment) | [Live host and authenticated local attachment](../development/local-attachment.md), [native bootstrap decision](../adr/044-controlled-local-process-bootstrap.md): controller wire methods, owned draining, process identity, writer exclusion and named-pipe reconnect; 20 native local unit and eight compiled process tests pass; connected task inspection/pause/cancel now add 76 engine/protocol, 13 public-host and seven compiled process checks; execution/resume orchestration and live cursor recovery remain | In_progress |
