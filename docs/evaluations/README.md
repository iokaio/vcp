...
- [P0-02 local resources](p0-02-local-resources.md): governed CPU/index measurements at 100, 1,000 and 10,000 records with independent recall and fresh-process checks.
- [P0-02 offline embeddings](p0-02-offline-embeddings.md): contained CPU inference, live network controls, missing/corrupt assets and explicit containment limits.
...
- [P0-02 local governance](p0-02-local-governance.md): scoped gate evaluation, retained disputes and historical visibility integrated with the real corpus experiment.
