...
`mcp-development` also completed its eighteen-run comparison. Candidate hard
...
and confirmation phases did not run. Skill-authoring 1.0.1's subsequent first
nearest-arm create-v3 run failed with canonical
...
- Preserve SKL 1.0.1's failed comparison. Its
  ...
  confirmation work. SKL 1.0.2 must receive a new store-feasibility receipt and
  new comparison; historical 1.0.0/1.0.1 results do not qualify it.
