...
export const RESULT_KINDS = {
  ...
  'backup/create': ['acceptance'],
  'backup/read': ['backup_job'],
  'backup/retry': ['acceptance'],
  'backup/cancel': ['acceptance'],
  'routing/reportCapture': ['acceptance'],
  'routing/reportRead': ['routing_report'],
  'routing/preview': ['routing_preview'],
  'routing/apply': ['acceptance'],
  'routing/rollback': ['acceptance'],
  'usage/read': ['usage'],
...
export const REQUIRED_PROFILES: Readonly<Partial<Record<Method, readonly string[]>>> = Object.freeze({
  ...
  'backup/status': Object.freeze(['backup/publisher/1']),
  'backup/create': Object.freeze(['backup/publisher/1']),
  'backup/read': Object.freeze(['backup/publisher/1']),
  'backup/retry': Object.freeze(['backup/publisher/1']),
  'backup/cancel': Object.freeze(['backup/publisher/1']),
  'routing/reportCapture': Object.freeze(['routing/optimizer/1']),
  'routing/reportRead': Object.freeze(['routing/optimizer/1']),
  'routing/preview': Object.freeze(['routing/optimizer/1']),
  'routing/apply': Object.freeze(['routing/optimizer/1']),
  'routing/rollback': Object.freeze(['routing/optimizer/1']),
