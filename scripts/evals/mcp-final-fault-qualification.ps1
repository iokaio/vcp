...
if (-not $OutputRoot) { $OutputRoot = Join-Path $repository 'artifacts/p7-mcp-final-fault-qualification' }
...
$record = [ordered]@{
    schema = 'p7-mcp-final-fault-qualification/1'; task = 'P7-03'; status = 'running'
    ...
    scope = 'MCP valid-reply interruption, authentication rejection and canonical host regressions'
}
