...
const checkerBuildScope = ['src/crates', 'src/evals/skills/authoring-qualification', 'src/evals/skills/authoring', 'src/evals/skills/authoring-followup', 'src/evals/skills/authoring-inherited', 'src/evals/skills/authoring-requalification', 'src/third_party/codex/codex-rs/Cargo.toml', 'src/third_party/codex/codex-rs/Cargo.lock', 'src/third_party/codex/codex-rs/rust-toolchain.toml'];
